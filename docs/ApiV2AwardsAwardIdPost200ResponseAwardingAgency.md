...
# ApiV2AwardsAwardIdPost200ResponseAwardingAgency
...
```typescript
import type { ApiV2AwardsAwardIdPost200ResponseAwardingAgency } from ''
...
} satisfies ApiV2AwardsAwardIdPost200ResponseAwardingAgency
...
const exampleParsed = JSON.parse(exampleJSON) as ApiV2AwardsAwardIdPost200ResponseAwardingAgency
